...
COLUMN_MAP: dict[str, tuple[str, object]] = {
    ...
    "power": ("DrivePower", _float),
    "energy_remaining": ("EnergyRemaining", _float),
    "tpms_pressure_fl": ("TpmsPressureFl", _float),
    "tpms_pressure_fr": ("TpmsPressureFr", _float),
    "tpms_pressure_rl": ("TpmsPressureRl", _float),
    "tpms_pressure_rr": ("TpmsPressureRr", _float),
